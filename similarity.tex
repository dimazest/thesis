...
\citet{rastogi-vandurme-arora:2015:NAACL-HLT,W16-2506} proposed a method for significance testing motivated by the fact that the researchers do dot report measures of significance of the difference between the Spearman correlations. Their method is based on finding a minimal required difference for significance (MRDS).
...
\begin{table}
  ...
  \begin{tabular}[th]{rl}
    ...
    \bottomrule
  \end{tabular}
  \caption{Minimal required difference for significance (MRDS) numbers for the datasets used in this work. Values for SimLex-999 and MEN are taken from \citet{rastogi-vandurme-arora:2015:NAACL-HLT}. KS14, GS11 and PhraseRel are described later in this work.}
  \label{tab:mrsd}
\end{table}
...
The $\sigma^{0.9}_{0.05}$ values for the lexical datasets and phrasal datasets (see next section and Chapter~\ref{sec:phraserel}) are listed in Table~\ref{tab:mrsd}.
