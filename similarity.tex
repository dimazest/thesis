...
In Information Retrieval (IR), queries are expanded with additional terms to retrieve more relevant documents. For example, if a user is looking for information about lakes in Sweden, the system might add related words to the query such as \textit{reservoir}, \textit{river} or even \textit{swim} \cite{Xu:1996:QEU:243199.243202}. % \cite{Salton:1975:VSM:361219.361220}
