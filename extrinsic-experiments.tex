...
Addition behaviour degrades as dimensionality increases, whereas multiplication behaviour increases, but becomes unstable for spaces with high number of dimensions. Kronecker depends the least on the dimensionality.
...
Overall, the difference is 0.049, which is within the limit set by H\ref{hyp:10percent}.
