...
\frac{1}{3}%
\frac{\operatorname{score}_\mathit{KS14}(\mathit{model})}%
{\max_m\operatorname{score}_\mathit{KS14}(m)}%
+%
\frac{1}{3}%
\frac{\operatorname{score}_\mathit{GS11}(\mathit{model})}%
{\max_m\operatorname{score}_\mathit{GS11}(m)}%
+%
\frac{1}{3}%
\frac{\operatorname{score}_\mathit{PhraseRel}(\mathit{model})}%
