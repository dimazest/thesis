...
% * <sdyck@ualberta.ca> 2017-03-01T02:04:22.400Z:
% 
% > require specially designed programming languages to be controlled, despite the fact that they play a crucial role in our lives
% This sentence doesn't really make sense. What do the programming languages have to do with the crucial role in our lives? Consider rewording.
% 
% ^.
...
% * <sdyck@ualberta.ca> 2017-03-01T02:24:09.857Z:
% 
% > fair
% I would consider using another word here, it just sounds a bit awkward. Maybe something like: " the operators can be compared in most accurate way." ?
% 
% ^.
...
% * <sdyck@ualberta.ca> 2017-03-01T02:29:50.892Z:
% 
% > composition-based 
% composition-based what? models? settings?
% 
% ^.
