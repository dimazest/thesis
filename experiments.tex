...
\begin{hyp}[H\ref{hyp:lex-pmi-cpmi}]
  ...
  In lexical tasks, there should be no difference between PMI and its compressed version CPMI (Section~\ref{sec:pmi-variants}). Shifted PMI variants behave the same (Section~\ref{sec:shifted-pmi}).
\end{hyp}
...
\end{hyp}
%
\todo[noline]{Mention the reason behind LMI.}
%
