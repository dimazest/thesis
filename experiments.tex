...
Models set with \texttt{neg} set to 0.2 become statistically different with more than 30\,000 dimensions.
...
Models that do not perform shifting (abbreviated as N/A in Figure~\ref{fig:SimLex999-neg}), peak at 20\,000 dimensions and decrease afterwards with increasing variance. With more than 10\,000 dimensions they are statistically different from the best result.
