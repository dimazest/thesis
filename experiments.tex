...
\todo[inline]{What's the best selection method.}
\todo[inline]{Does Max overfit?}
\todo[inline]{Statistical significance.}
\todo[inline]{Title: mention PMI?}
...
\paragraph{Difference between Max selection and heuristics}
...
\paragraph{Difference between Max selection and heuristics on MEN}
...
\paragraph{Difference between heuristics based on MEN and SimLex-999}
...
\paragraph{Context distribution smoothing}
