...
Table~\ref{tab:ks14-heuristics-selection} shows the selection based on heuristics. Both methods agree on the similarity choice (with an exception of \texttt{head}).
