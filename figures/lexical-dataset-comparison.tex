...
\begin{table}
  ...
  \caption[Lexical datasets]{Model performance on various datasets. For
    ...
    The state of the art are \newcite{Halawi:2012:LLW:2339530.2339751} for
    WS353, \newcite{baroni-dinu-kruszewski:2014:P14-1} for MEN
    and \newcite{recski-EtAl:2016:RepL4NLP}, which is a not pure distributional model, for SimLex-999.
  }
