...
\chapter{PhraseRel: an IR-inspired dataset}
\label{sec:phraserel}
...
We got 23 unique documents (1 \texttt{ks14}, 2 \texttt{wordnet}, 7
...
An example of a question is shown on Figure~\ref{fig:task}. The \dataurl{phraserel-raw.csv} file consists of human judgements together with anonymized Worker and HIT identifiers.
