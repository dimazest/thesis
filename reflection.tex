...
\section{PhraseRel: An IR-inspired evaluation dataset}
\label{sec:phraserel}
...
\subsection{Preparation of candidate entries for the dataset}
\label{sec:design}
...
\subsubsection{Vector space similarity score}
...
\subsection{Final dataset construction}
